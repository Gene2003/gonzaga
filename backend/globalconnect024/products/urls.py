...
from .views import BooklistCreateview  # ✅ Import the Book list/create view
...
urlpatterns = [
    ...
    path('books/', BooklistCreateview.as_view(), name='book-list-create'),  # ✅ Book list/create endpoint
